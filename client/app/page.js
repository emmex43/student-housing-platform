    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <nav className="flex justify-between items-center p-4 md:p-6 bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="md:hidden flex gap-2">
          <Link href="/login" className="bg-green-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-green-700 transition">
            Login
          </Link>
        </div>
        ...
        <div className="hidden md:flex space-x-4">
          <Link href="/login" className="bg-green-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-green-700 transition">
            Login
          </Link>
          <Link href="/register" className="border border-green-600 text-green-600 px-6 py-2 rounded-lg font-semibold hover:bg-green-700 hover:text-white transition">
            Sign Up
          </Link>
        </div>
      </nav>
            ...
            {properties.map((property) => (
              <div key={property.id} className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100 group">
                ...
                <div className="h-64 overflow-hidden relative">
                  ...
                  {property.videoUrl && (
                    <div className="absolute top-4 left-4 bg-red-500/90 backdrop-blur px-3 py-1 rounded-full text-xs font-bold text-white shadow-sm">
                      🎥 Video
                    </div>
                  )}
                </div>
